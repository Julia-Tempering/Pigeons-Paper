...
distributed and randomized algorithm satisfying SPI. Finally, we discuss a new
module that enables Pigeons to sample from arbitrary programs written in 
a Turing-complete probabilistic programming language.
\end{abstract}